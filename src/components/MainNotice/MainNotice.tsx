        ...
        >
          <SwiperSlide className="glass-effect-card">
            ...
            <div className="bubble">
              <Image
                src="/image/notice-icon/notice1.svg"
                width={50}
                height={50}
                alt="not"
                loading="lazy"
          ...
          <SwiperSlide className="glass-effect-card">
            ...
            <div className="bubble">
              <Image
                src="/image/notice-icon/notice2.svg"
                width={50}
                height={50}
                alt="not"
                loading="lazy"
          ...
          <SwiperSlide className="glass-effect-card">
            ...
            <div className="bubble">
              <Image
                src="/image/notice-icon/notice3.svg"
                width={50}
                height={50}
                alt="not"
                loading="lazy"
          ...
          <SwiperSlide className="glass-effect-card">
            ...
            <div className="bubble">
              <Image
                src="/image/notice-icon/notice4.svg"
                width={50}
                height={50}
                alt="not"
                loading="lazy"
          ...
          <SwiperSlide className="glass-effect-card">
            ...
            <div className="bubble">
              <Image src="/image/coin.svg" width={50} height={50} alt="not" loading="lazy" />
            </div>
          </SwiperSlide>
        </Swiper>
      </div>
